    ...
    <div class="form-content limitHeight">
        <el-form ref="form" :model="formData" label-position="right" :rules="ruleForm">
            <com-ocj-form-item :form="formData" :config="formConfig" :column="1" clearable>
                ...
                <template #codeKey_id>
                  <el-select v-model="formData.codeKey_id" filterable placeholder="请选择员工编号" style="width: 320px;" clearable>
                    <el-option
    ...
    computed:{
        ...
        formConfig(){
            return [
                ...
                {itemType:'input',prop:'codeKey_id',label:'员工编号',placeholder:'请选择员工编号', hasSlot:true},
                {itemType:'input',prop:'name',label:'员工姓名',placeholder:'请输入员工姓名',width:'320px'},
